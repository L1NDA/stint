                ...
                <form onSubmit={this.uploadCompanyData}>
                  ...
                  <div className="flex-column">
                    <div>
                      ...
                      <label
                        for="analytics"
                        onClick={() => this.handleCheckbox(ANALYTICS)}
                      >
                        {" "}
                        Analytics{" "}
                      </label>
                    ...
                    <div>
                      ...
                      <label
                        for="business"
                        onClick={() => this.handleCheckbox(BUSINESS)}
                      >
                        {" "}
                        Business{" "}
                      </label>
                    ...
                    <div>
                      ...
                      <label
                        ...
                        onClick={() => this.handleCheckbox(DIGITAL_MARKETING)}
                      >
                        {" "}
                        Digital Marketing{" "}
                      </label>
                    ...
                    <div>
                      ...
                      <label
                        for="engineering"
                        onClick={() => this.handleCheckbox(ENGINEERING)}
                      >
                        {" "}
                        Engineering{" "}
                      </label>
                    ...
                    <div>
                      ...
                      <label
                        for="graphicsdesign"
                        onClick={() => this.handleCheckbox(GRAPHICS_DESIGN)}
                      >
                        {" "}
                        Graphics & Design{" "}
                      </label>
                    ...
                    <div>
                      ...
                      <label
                        for="videomedia"
                        onClick={() => this.handleCheckbox(VIDEO_MEDIA)}
                      >
                        {" "}
                        Video & Media{" "}
                      </label>
                    ...
                    <div>
                      ...
                      <label
                        for="writing"
                        onClick={() => this.handleCheckbox(WRITING)}
                      >
                        {" "}
                        Writing{" "}
                      </label>
              ...
              {this.props.category === STUDENT ? (
                <form onSubmit={this.onCreateMessage}>
                  ...
                  >
                    ...
                    <option value="design" className="dropdown-item">
                      Design
                    </option>
                    <option value="engineering" className="dropdown-item">
                      Engineering
                    </option>
                    <option value="creatives" className="dropdown-item">
                      Creatives
                    </option>
                    <option value="analytics" className="dropdown-item">
                      Analytics
                    </option>
                  </select>
