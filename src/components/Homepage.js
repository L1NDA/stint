...
class Homepage extends React.Component {
  ...
  handleButtonClick = async (event) => {
    ...
    console.log(createCheckoutSession({"name": "stint stuff"}, 1000, "https://wearestint.com/hire", "https://wearestint.com/our-mission"))
  ...
  loginWithProvider = async (provider) => {
    ...
    if (!this.props.isLoggedIn) {
      this.props.loginUser({ provider, onError: this.onError }, () =>
        this.props.analytics.logEvent(LOGIN_EVENT)
      );
    } else {
      ...
      <div className="homepage">
        {this.state.cookies ? null : (
          <div className="cookies">
            <TiTimes
              className="modal-x"
              onClick={this.handleCookiesClick}
              style={{
                top: "50%",
            ...
            />
            <div className="subtitle" style={{ marginRight: "20px" }}>
              By continuing to use our site, you are agreeing to our{" "}
              <Link to="/privacy-policy">Privacy Policy</Link>. We also use
              cookies on our site to give you the best user experience.{" "}
              <span className="nobreak-comp">
        ...
        >
          ...
          <p
            style={{ textAlign: "center", color: "white", textWrap: "balance" }}
          >
            Be seen by companies before your coffee is brewed (or your Java
            compiled 🤓)
          </p>
          <br />
          <GoogleButton
        ...
        <div className="covid">
          In light of COVID-19, we hope to support students and companies in any
          way we can. If you are a company looking to hire, we’d love to&nbsp;
          <a href="mailto:wearestint@gmail.com" className="url">
            hear from you.
          </a>
        </div>
        ...
        >
          <div className="homepage-text">
            <h1>
              Get ahead with <span className="nobreak">real work.</span>
            </h1>
            <h3>
        ...
        <div className="flex-column center" className="one-liner">
          <div className="h1-smaller">
            Shorter Work Opportunities that{" "}
            <span className="nobreak-comp">
              Empower You to <span className="nobreak">Always Grow.</span>
            </span>
          </div>
          <h3 style={{ textAlign: "center" }}>
            We believe in helping you grow professionally at any time. It
            shouldn’t take months of recruiting for you to finally get the
            chance to do industry work. You have skills now – so we’ll give you
            work now.
          </h3>
          ...
          <div className="process">
            ...
            <div className="process-item">
              ...
              <div className="process-text">
                <h2>Sign Up</h2>
                <p>
                  Create your account and build a profile that highlights your
                  skills. Don’t worry if you think you don’t have enough to show
                  – our companies are looking for a wide range of skills, from
                  managing social media to designing web pages.
                </p>
              </div>
            </div>
            <div className="process-item">
              ...
              <div className="process-text">
                <h2>Sit Back</h2>
                <p>
                  Continue on with your day-to-day. You’ll get an email when a
                  company has a project for you and wants to connect.
                </p>
              </div>
            </div>
            <div className="process-item">
              ...
              <div className="process-text">
                <h2>Get Stintin’</h2>
                <p>
                  We’ll help you sort out the project logistics. If you decide
                  to take the offer, you can get started right away.
                </p>
              </div>
            </div>
            <div className="process-item">
              ...
              <div className="process-text">
                <h2>Circle Back</h2>
                <p>
                  After your stint, leave a review for the company you worked
                  with. They’ll do the same for you. As you complete more
                  stints, reviews will boost your credibility.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-column" style={{ backgroundColor: "#f5f5f5" }}>
          <div className="flex-row interstitial">
            <div className="interstitial-item">
              ...
              <p>
                Bootcamps and extracurriculars aren’t the only way to get
                real-world experience as a full-time student. Gain industry
            ...
            <div className="interstitial-item">
              ...
              <p>
                Got extra time on your hands? Do stints and earn some money for
                those next few burritos – on your own time, at your own pace.
              </p>
            </div>
            ...
            <div className="interstitial-item">
              ...
              <p>
                We believe in challenging the status quo. Spend your time doing
                meaningful work instead of networking. Highlight your skills,
        ...
        <div className="flex-column center padding process-container">
          ...
          <div className="accordion">
            <Collapsible trigger="What’s a ‘stint’?" transitionTime={200}>
              <p>
                ‘Stints’ are what we call the projects that companies will hire
                you for through our platform.
              </p>
            </Collapsible>
            <Collapsible
              trigger="What skills do I need to join?"
              transitionTime={200}
            >
              <p>
                You can join with whatever skills you have. Currently, we group
                skill areas into four categories: data analytics, design &
                branding, content creation & management, and software
                engineering. <br />
                <br />
                Keep in mind that companies have all sorts of needs, so you’re
                more than likely to find a match for your skills.
              </p>
            </Collapsible>
            <Collapsible trigger="How do I get started?" transitionTime={200}>
              <p>
                If you’re a student, click the button below to sign up now and
                make your profile. If you’re a company,{" "}
                <NavLink to="/hire" className="link">
            ...
            <Collapsible
              trigger="How much will I get paid?"
              transitionTime={200}
            >
              <p>
                You’ll have the chance to negotiate an hourly rate with
                companies when they reach out to hire you for a stint. We will
                help facilitate this process to ensure mutual satisfaction for
                you and the company.
              </p>
            </Collapsible>
            <Collapsible trigger="When will I get paid?" transitionTime={200}>
              <p>
                You’ll be able to track your earnings on the platform from the
                day you start a stint. Actual payment will begin one quarter
                into the project timeline, at which point we will start
                transferring payment into your bank account at the agreed hourly
                rate – including your earnings from the first quarter.
                <br />
                <br />
                Remember that payments may take 2-5 days to appear in your bank
                account.
              </p>
            </Collapsible>
            <Collapsible
              trigger="Do I have to be a student to join?"
              transitionTime={200}
            >
              <p>
                Unfortunately, our platform is only for student freelancers as
                of now. We believe that student talent is often overlooked in
                the market and hope to empower students to gain industry
                experience right away.
                <br />
                <br />
                If you are a company looking to hire a student,{" "}
                <NavLink to="/hire" className="link">
                  visit our companies page
                </NavLink>{" "}
                to get started.
            ...
            <Collapsible
              trigger="Do you offer internships?"
              transitionTime={200}
            >
              <p>
                We created Stint to help students gain industry experience
                whether or not they are able to land an internship. We’ve
                eliminated the hassle and time commitment of ‘recruiting’ and
                provide immediate work opportunities to encourage students to
                always be growing professionally.
              </p>
              <button
                style={{ marginTop: "50px" }}
                className="button"
                onClick={this.handleButtonClick}
              >
                Start your first real work experience with us
              </button>
            </Collapsible>
          </div>
          <h2
        ...
        <div
          className="cta flex-column center"
          style={{ padding: "150px 10%", backgroundColor: "#f5f5f5" }}
        >
          <h1 style={{ textAlign: "center" }}>
            Join our community <br />
            of do-ers and <span className="nobreak">go-getters.</span>
          </h1>
          <h3 style={{ textAlign: "center" }}>
            We brought Stint to life inspired by you. Now give it a try and see
            if you dig it.
          </h3>
          <button
            style={{ marginTop: "50px" }}
