      ...
      <div className="container flex-column" style={{height: "100vh"}}>
        ...
        <div className="fof-container">
          <div className="fof">
            ...
            <h3>
              While we fix ourselves up, <br />
              why don’t you try the buttons below?‍
            </h3>
            {this.props.isLoggedIn ? (
              <Link to="/our-mission" style={{ marginTop: "20px" }}>
              ...
              <div className="flex-row center" style={{ marginTop: "20px" }}>
                ...
                >
                  ...
                  >
                    Be seen by companies before your coffee is brewed (or your
                    Java compiled 🤓)
                  </p>
                  <br />
                  <GoogleButton
