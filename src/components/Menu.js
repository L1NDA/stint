...
import { HOMEPAGE_PATH,
         COMPANY_PATH,
         ABOUT_PATH,
         PROFILE_VIEW_PATH } from "../constants/ROUTING_CONSTANTS"
          ...
          {this.props.profilePic
            ?
              <div className="menu-profile flex-row">
                <Link to={PROFILE_VIEW_PATH}><img src={this.props.profilePic} className="menu-propic-solo"/></Link>
            ...
            : this.props.isLoggedIn ?
              <div className="menu-profile flex-row">
                <Link to={PROFILE_VIEW_PATH}><div className="menu-propic-solo" style={{backgroundColor: "#f5f5f5"}}></div></Link>
              </div>
            : null}
        </div>
        <Burger right>
          {this.props.firstName ?
            ...
            <Link to={PROFILE_VIEW_PATH}><img src={this.props.profilePic} className="menu-propic"/></Link>
            <div className="menu-name">{this.props.firstName.split(' ')[0]}</div>
            <Link to={PROFILE_VIEW_PATH} className="menu-burger-profile">My Profile</Link>
            </div>
            : null
          }
